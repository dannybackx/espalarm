...
Sensors::Sensors() {
  ...
  AddSensor(SENSOR_10_ID, SENSOR_10_NAME, SENSOR_10_ZONE);
  AddSensor(SENSOR_11_ID, SENSOR_11_NAME, SENSOR_11_ZONE);
  AddSensor(SENSOR_12_ID, SENSOR_12_NAME, SENSOR_12_ZONE);
  AddSensor(SENSOR_13_ID, SENSOR_13_NAME, SENSOR_13_ZONE);
  AddSensor(SENSOR_14_ID, SENSOR_14_NAME, SENSOR_14_ZONE);
  AddSensor(SENSOR_15_ID, SENSOR_15_NAME, SENSOR_15_ZONE);
}
